...
<div class="card custom-card overflow-hidden ocultar_mobile" style="margin-top: 40px;width: 100%; max-width: 1000px;">
    <div class="card-header border-bottom-0">
        <div>
            <h3 class="card-title mb-2">Recebimentos / Despesas <?php echo $ano_atual ?></h3>
