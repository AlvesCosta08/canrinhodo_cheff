	...
	<form action="rel/receber_class.php" target="_blank" method="POST">
		<div class="left-content mt-2">
			...
			<a style="margin-bottom: 20px; margin-top: 20px" class="btn ripple btn-primary text-white" onclick="inserir()"
				type="button"><i class="fe fe-plus me-1"></i>Adicionar Conta</a>
			...
			<!--<div class="col-md-3" style="display: inline-block; margin-bottom: 10px; margin: 10px 10px;">
				<input type="date" name="data-inicial" class="form-control2" id="data-inicial"
					value="<?php //echo $data_inicio_mes ?>" required onchange="$('#filtro_input').val(''); buscar()">

				<input type="date" name="data-final" class="form-control2" id="data-final" value="<?php //echo $data_final_mes ?>"
					required onchange="$('#filtro_input').val(''); buscar()">
			</div> -->
		...
		<div class="modal-content">
			...
			<form id="form-contas">
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-6 mb-2 col-8 needs-validation was-validated">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<label>Cliente</label>
							<select name="cliente" id="cliente" class="sel3" style="width:100%; height:35px; ">
						...
						<div class="tile">
							<div class="table-responsive">
								<table id="" class="text-left table table-bordered">
									<tr>
										<td class="bg-primary text-white width30">Cliente</td>
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="mb-3">
								...
								<input type="number" class="form-control" name="qtd-parcelar" id="qtd-parcelar" placeholder="1"
									required>
							</div>
						</div>
