...
<div class="justify-content-between mt-4">
	...
	<div class="left-content mt-2 mb-3">
		<span style="margin-right: 20px;"><a class="btn ripple btn-primary text-white" onclick="inserir()" type="button"><i class="fa fa-plus" aria-hidden="true"></i> Adicionar Tarefa</a></span>

		<span class="<?php echo $lancar_tarefas ?>">
			<select class="form-control sel50 " aria-label="Default select example" name="usuario_selecionado" id="usuario_selecionado" style="width:350px;" onchange="buscar()">
				<?php
