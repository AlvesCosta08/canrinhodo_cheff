...
<div class="justify-content-between">
	...
	<div class="row">
		 ...
		 <div style="display: inline-block; margin-bottom: 10px; margin: 10px 10px;">
			<input type="date" name="data-inicial" class="form-control2" id="data-inicial-caixa" style="height:35px; width:49%; font-size: 13px;" value="<?php echo date('Y-m-d') ?>" required>

			<input type="date" name="data-final" class="form-control2" id="data-final-caixa" style="height:35px; width:49%; font-size: 13px;" value="<?php echo date('Y-m-d') ?>" required>	
		</div>	
