...
<div class="bs-example widget-shadow" style="padding:15px; margin-top: 15px">
	...
	<div class="row">
		...
		<div class="col-md-3" >	
			<div class="form-group">			
				<select class="form-select sel_comissao" id="funcionario" name="funcionario" style="width:100%;" onchange="listar()"> <option value="">Filtrar Funcionário</option>
				<?php 
	...
	<div class="col-md-3">
		<button  onclick="baixarTudo()" type="button" class="btn btn-success"> Baixar Comissões<i class="fa fa-check ms-2"></i></button>
	</div>
