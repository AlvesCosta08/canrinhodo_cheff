...
$conclusao2 = $_POST['conclusao2'];
$conclusao3 = $_POST['conclusao3'];
$conclusao4 = $_POST['conclusao4'];
$conclusao5 = $_POST['conclusao5'];
...
$conclusao2 = str_replace('*', '', $conclusao2);
$conclusao2 = str_replace('"', '', $conclusao2);
$conclusao2 = str_replace("'", "", $conclusao2);
...
$conclusao4 = str_replace('*', '', $conclusao4);
$conclusao4 = str_replace('"', '', $conclusao4);
$conclusao4 = str_replace("'", "", $conclusao4);

$conclusao5 = str_replace('*', '', $conclusao5);
$conclusao5 = str_replace('"', '', $conclusao5);
$conclusao5 = str_replace("'", "", $conclusao5);
...
$query->bindValue(":conclusao2", "$conclusao2");
$query->bindValue(":conclusao3", "$conclusao3");
$query->bindValue(":conclusao4", "$conclusao4");
$query->bindValue(":conclusao5", "$conclusao5");
