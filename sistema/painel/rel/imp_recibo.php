...
<table class="printer-ticket">
	...
	<tr>
		<th class="ttu" class="title" colspan="3"><img style="margin-top: 10px; margin-left: 50px;" id="imag" src="<?php echo $url_sistema ?>sistema/img/logo.jpg" width="180px">
		</th>
	</tr>

	<tr style="font-size: 10px">
		<th colspan="3">
			<?php if ($endereco_sistema != "") { ?> <?php echo $endereco_sistema ?> <br /><?php } ?>
			Contato: <?php echo $telefone_sistema ?>
			<?php if ($cnpj_sistema != "") { ?> / CNPJ <?php echo  $cnpj_sistema  ?><?php } ?>
		</th>
	</tr>
