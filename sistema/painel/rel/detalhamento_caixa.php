...
<body>
	...
	<div id="header">
		...
		<div style="border-style: solid; font-size: 8px; height: 80px;margin-top:-20px">
			<table style="width: 100%; border: 0px solid #ccc;">
				<tr>
					<td style="border: 1px; solid #000; width: 40%; text-align: left;">
						<img style="margin-top: -2px; margin-left: 7px;" id="imag" src="<?php echo $url_sistema ?>sistema/img/logo.jpg" width="80px">
					</td>
					...
					<td style="width: 25%; text-align: right; font-size: 9px;padding-right: 10px;">
		...
		<table id="cabecalhotabela" style="border-bottom-style: solid; font-size: 12px; margin-bottom:90px; width: 100%; table-layout: fixed;">
