...
// Executar a query com debug
$query1 = $pdo->prepare("SELECT * FROM caixas WHERE usuario_abertura = :id AND data_fechamento IS NULL ORDER BY id DESC LIMIT 1");
$query1->execute(['id' => $id_usuario]);
...
//echo "Texto do caixa: $texto_caixa";
...
<head>
	...
	<meta name="Description" content="Sistema para Delivery Interativo, sistemas para delivery, delivery interativo, sistemas Cantinho do Cheff, cantinho,cheff">
	<meta name="Author" content="Cantinho do Cheff">
	<meta name="Keywords" content="sistema para delivery, sistemas cantinho do cheff, sistemas cantinho, portal cantinho do cheff" />
	...
	<div class="page">
		...
		<div class="main-footer">
			<div class="container-fluid pt-0 ht-100p">
				Copyright © <?php echo date('Y'); ?> Desevolvedor<a target="_BLACK" href="https://codigoquatro.com.br/site/"
					class="text-primary"> Cantinho do Cheff</a>. Todos os direitos reservados
			</div>
		</div>
		<!--######################## FIM RODAPÉ ###########################-->
