...
<body>
	<div class="login" >		
		<div class="form">
				<div class="d-flex mb-4 justify-content-center" style="margin-top: 30px"><img src="img/logo.png"	class="sign-favicon" alt="logo" width="70%"></div>
       ...
       <br>
        ...
        <input placeholder="Repetir Senha" class="form-control" type="password" name="re_senha" id="re_senha" required>     
       	...
       	<input type="hidden" name="email" id="email" value="<?php echo $_REQUEST['email'] ?>">
			...
			<button type="submit" class="btn btn-block btn-alterar-senha">ALTERAR SENHA</button>
