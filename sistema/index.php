...
<head>
	...
	<meta name="Description" content="Sistema para Delivery Interativo, sistemas para delivery, delivery interativo, sistemas Cantinho do Cheff, sistemas canrinhodo cheff, sistemas cheff">
	<meta name="Author" content="Cantinho do Cheff">
	<meta name="Keywords" content="sistema para delivery, sistemas cantinho do cheff, sistemas cheff, portal cantinho do cheff" />
							...
							<div class="main-card-signin d-md-flex">
								<div class="wd-100p">
									<div align="center" class="d-flex mb-4 justify-content-center"><a href="index.php"><img
												src="img/logo.png" class="sign-favicon" alt="logo" width="50%"></a></div>
									<div class="">
